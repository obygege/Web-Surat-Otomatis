    ...
    <div className="min-h-screen flex flex-col font-normal text-futura-text bg-futura-bg relative scroll-smooth">
      ...
      <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-gray-200 px-6 py-4 flex justify-between items-center shadow-sm">
        <div className="text-2xl tracking-wider flex items-center gap-2 cursor-pointer" onClick={() => { setHalamanAktif('beranda'); setTampilkanPilihan(false); }}>
          <svg className="w-6 h-6 text-futura-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
        ...
        <div className="flex items-center gap-4">
          {userAktif ? (
            ...
            <button onClick={() => setShowAuthModal(true)} className="bg-slate-900 text-white font-medium text-sm px-6 py-2.5 rounded-md hover:shadow-lg hover:bg-slate-800 transition-all duration-300">Masuk / Daftar</button>
          )}
        </div>
      </header>
          ...
          <>
            <section id="beranda" className="relative flex flex-col items-center justify-center text-center px-4 py-32 lg:py-40 overflow-hidden bg-white">
              ...
              <div className="relative z-10">
                ...
                <button onClick={handleBuatSurat} className="animate-scale-in delay-300 bg-blue-600 text-white font-medium text-xl px-12 py-5 rounded-md hover:bg-blue-700 hover:shadow-xl hover:shadow-blue-500/30 transition-all duration-300 transform hover:-translate-y-1">
              ...
              <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  {[
                    ...
                    { title: "Desa & Dukcapil", desc: "SKTM, SKU, Pengantar RT, Surat Pindah", icon: <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg> },
